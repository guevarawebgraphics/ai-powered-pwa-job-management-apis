...
$sql = "UPDATE gigs SET time_ended = NOW() WHERE gig_id = ?";
...
if ($stmt->execute()) {
    echo json_encode(["status" => "success", "message" => "Gig has been successfully ended for Gig ID: $gigID."], JSON_PRETTY_PRINT);
} else {
